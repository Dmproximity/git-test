...
try {
        ...
        for (var i = 0; i < sandboxWhitelist.length; i++) {
            ...
            with(this) {
                ...
                __d("JSSDKRuntimeConfig", [], {
                    ...
                    "sdkab": null,
                    "sdkns": "FB",
                    "sdkurl": "https:\/\/connect.facebook.net\/en-GB\/sdk.js"
                });
                __d("JSSDKConfig", [], {
                    "bustCache": true,
    ...
    new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"4129020","namespace":"FB","message":"' + e.message + '"}}');
}

//Added
FB.init({
    appId: "329430520817081",
    cookie: true,
    xfbml: true,
     version: "v2.8",
   oauth: true
